...
const socialMediaLinks = [
  ...
  },
  {
    ...
    href: 'https://stackoverflow.com/users/2284240/vishal',
    color: '#f48023',
  ...
  },
  {
    id: 'upwork',
    Icon: UpworkIcon,
    href: 'https://www.upwork.com/freelancers/~0182ec4fe968012d82',
    color: '#15a900',
    tooltip: 'Upwork',
  },
  {
    id: 'toptal',
    Icon: ToptalIcon,
    href: 'https://www.toptal.com/resume/vishal-sherathiya',
    color: '#204ecf',
    tooltip: 'Toptal',
  },
  {
    id: 'linkedin',
    Icon: LinkedInIcon,
    href: 'https://www.linkedin.com/in/vishal-sherathiya/',
    color: '#0a66c2',
    tooltip: 'Linked in',
  },
  {
    id: 'x',
    Icon: XIcon,
    href: 'https://twitter.com/vpsherathiya',
    color: '#0f1419',
    tooltip: 'X',
  },
];
